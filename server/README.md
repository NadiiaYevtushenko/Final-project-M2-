...
- 📦 Читання даних з колекції `products`
- 🧭 SSR-маршрути:
  - `/products/db` — усі товари
  - `/products/category` — список категорій
  - `/products/category/:category` — товари з категорії
  - `/products/:id` — один товар
- 🧩 Створено шаблони EJS для товарів
